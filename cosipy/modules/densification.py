...
def method_Boone(GRID,SLOPE):
    ...
    lwc = np.copy(GRID.get_liquid_water_content())
    t = np.copy(GRID.get_temperature())
    icf = np.copy(GRID.get_ice_fraction())
...
def method_empirical(GRID,SLOPE):
