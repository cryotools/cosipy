...
class Grid:
    ...
    def init_grid(self):
        ...
        for idxNode in range(self.nnodes):
            self.grid.append(node.Node(self.hlayersList[idxNode], self.rhoList[idxNode], 
    ...
    def add_node(self, hlayer, rho, T, LWC):
        ...
        # Add new node
        self.grid.insert(0,node.Node(hlayer, rho, T, LWC))
    ...
    def add_node_idx(self, idx, hlayer, rho, T, LWC):
        ...
        # Add new node
        self.grid.insert(idx, node.Node(hlayer, rho, T, LWC))
