...
temperature_top = 264.                  # Upper boudary conditation for inital temperature profile (K)
...
albedo_firn = 0.60                      # albedo of firn [-] (Moelg etal. 2012, TC)
albedo_ice = 0.34                       # albedo of ice [-] (Moelg etal. 2012, TC)
