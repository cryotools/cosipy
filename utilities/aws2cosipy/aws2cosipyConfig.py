...
stationAlt_RRR_mean = 1899.0	# If you use the same weather stations as for all other values: use mean altitude of 'station_valley' and 'station_mountain'
# AltBEC = 2090
# AltPON = 1708
...
U2_constant = True
U2_const = 3.0		     # constant value for the wind velocity
