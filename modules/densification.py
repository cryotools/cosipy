    ...
    if densification_method == 'Herron80':
        ...
        for idxNode in range(0,GRID.number_nodes-1,1):
            ...
            if GRID.get_node_density(idxNode) < snow_firn_threshold:
                density_temp[idxNode] = GRID.get_node_density(idxNode) + K0 * np.exp(-E0/(R * GRID.get_node_temperature(idxNode)))\
        ...
        print('ERROR: Densification parameterisation ', densification_method, ' not availalbe')
        sys.exit()